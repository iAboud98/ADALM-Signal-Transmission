...
class demodulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demodulation")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 300000, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 260000, 300000, 15000, window.WIN_HAMMING, 6.76))
        self.iio_pluto_source_0.set_samplerate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(3, self.samp_rate, 20000, 2500, window.WIN_HAMMING, 6.76))




def main(top_block_cls=demodulation, options=None):
